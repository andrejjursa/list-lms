            ...
            <div id="tabs-form">
                <form action="{internal_url url="admin_solutions/update_valuation/{$solution->task_set->id|intval}/{$solution->id|intval}"}" method="post">
                    <div class="field">
                        ...
                        <p class="input"><input type="text" name="solution[points]" value="{$smarty.post.solution.points|default:$solution->points|escape:'html'}" id="solution_points_id" /></p>
                        <p class="input"><em>{translate|sprintf:{$solution->task_set_total_points|floatval} line='admin_solutions_valuation_form_label_points_hint'}</em></p>
