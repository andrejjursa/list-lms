...
<html>
    ...
    <body>
        ...
        <p>{translate|sprintf:{$points_to_remove|floatval}:$task_set_name:{$task_set->upload_end_time|date_format:{translate line='common_datetime_format'}} line='admin_solutions_remove_points_notification_text'}</p>
