<html>
    <head>
        <meta charset="utf-8" />
        <title>LIST - {translate line='tasks_comments_email_subject_new_post'}</title>
    </head>
    <body>
        <h1>{translate line='tasks_comments_email_subject_new_post'}</h1>{capture name='task_set_name' assign='task_set_name'}{overlay table='task_sets' table_id=$task_set->id column='name' default=$task_set->name}{/capture}
