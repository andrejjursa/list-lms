...
<html>
    <head>
        ...
        <link type="text/css" rel="stylesheet" media="screen" href="{'/public/css/frontend_popup.css'|base_url}" />
    ...
    <body>
        <div id="popupwrap"><div class="internal_padding">{block name='main_content'}{/block}</div></div>
    </body>
</html>