    ...
    <fieldset>
        <form action="{internal_url url='admin_translationseditor/save_new_constant/'}" method="post">
            <div class="field">
                ...
                <p class="input"><input type="text" maxlength="255" name="translation[constant]" value="{$smarty.post.translation.constant|escape:'html'}" /></p>
            ...
            <div class="field">
                ...
                <p class="input"><textarea name="translation[text][{$idiom}]">{$smarty.post.translation.text[$idiom]|escape:'html'}</textarea></p>
            </div>
            {/foreach}
            <div class="buttons">
