...
<tr>
    ...
    <td><a href="{internal_url url="admin_courses/edit/course_id/{$course->id}"}" class="button">{translate line='admin_courses_table_controlls_edit'}</a></td>
    <td><a href="{internal_url url="admin_courses/delete/course_id/{$course->id}"}" class="button">{translate line='admin_courses_table_controlls_delete'}</a></td>
</tr>
{foreachelse}
<tr>
    <td colspan="4">
