...
<tr>
    ...
    <td>{translate_text text=$task_set->course->name} / {translate_text text=$task_set->course_period_name}</td>
    <td>{translate_text text=$task_set->task_set_type->name}</td>
...
<tr id="pagination_row_id">
    <td colspan="6">{include file='partials/backend_general/pagination.tpl' paged=$task_sets->paged inline}</td>
</tr>