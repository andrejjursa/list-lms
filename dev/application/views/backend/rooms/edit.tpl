        ...
        <fieldset>
            <form action="{internal_url url="admin_rooms/update/{$group_id}"}" method="post">
                ...
                <div class="field">
                    ...
                    <div class="input">
                        <select name="room[teachers][]" multiple="multiple" size="5" id="room_teachers_id">
                            {html_options options=$teachers selected=$smarty.post.room.teachers|default:$room->selected_teachers()}
                        </select>
                    </div>
                ...
                <div class="field">
                    ...
                    <p class="input"><input type="text" name="room[teachers_plain]" value="{$smarty.post.room.teachers_plain|default:$room->teachers_plain|escape:'html'}" id="room_teachers_plain_id" /></p>
