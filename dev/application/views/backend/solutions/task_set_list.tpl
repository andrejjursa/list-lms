{foreach $task_sets as $task_set}
    <tr>
        ...
        <td class="controlls"><a href="{internal_url url="admin_solutions/remove_points/{$task_set->id}"}" class="button special remove_points points:2">{translate line='admin_solutions_table_button_remove_points'}</a></td>
    </tr>
{/foreach}
