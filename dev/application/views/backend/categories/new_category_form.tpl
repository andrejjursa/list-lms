...
<div class="field">
    ...
    <p class="input"><select name="category[parent_id]" size="1" id="category_parent_id_id">
        <option value=""></option><option value="root">[{translate line='admin_categories_parent_category_root'}]</option>{categories_tree_options structure=$structure selected=$smarty.post.category.parent_id}
    </select></p>
