...
$lang['java_tests_config_form_unit_test_class_to_run_hint'] = 'For security reason test file which will be run is named as Test<strong>&lt;your test file name&gt;</strong>.zip.<br /><strong>Example:</strong> Test<strong>Square</strong>.zip';
