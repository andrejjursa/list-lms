(function($) {
    ...
    $.extend($.activeForm, {
        ...
        prototype: {
            init: function() {
                $(this.workOnForm).find('input, textarea, select, button').change($.activeForm.processConditions);
                $(this.workOnForm).find('input, textarea, select, button').keyup($.activeForm.processConditions);
                $(this.workOnForm).find('input, textarea, select, button').select($.activeForm.processConditions);
                $(this.workOnForm).find('input, textarea, select, button').click($.activeForm.processConditions);
                var actionForm = this;
