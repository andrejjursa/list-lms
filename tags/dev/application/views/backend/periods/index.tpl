...
{block custom_head}<script type="text/javascript">
    var messages = {
        delete_question: '{translate|addslashes line="admin_periods_delete_period_question"}',
        after_delete: '{translate|addslashes line="admin_periods_after_delete_message"}',
    };
</script>{/block}