...
$lang['admin_task_sets_form_label_test_min_needed'] = 'Minimum tests needed for evaluation';
$lang['admin_task_sets_form_label_test_min_needed_hint'] = 'Number of tests that student must select for evaluation of task set solution. If this number is greater than number of evaluating tests, it will be corrected in evaluation process.';
$lang['admin_task_sets_form_label_test_max_allowed'] = 'Maximum tests allowed for evaluation';
$lang['admin_task_sets_form_label_test_max_allowed_hint'] = 'Maximum number of tests that will be considered for evaluation. This number is the number of best results from tests which will be summed into points.';
