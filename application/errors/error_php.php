...
<?php else: ?>
    <div
        style="border:1px solid #990000;padding:20px;margin:5px 0 5px 0;border-radius: 5px;box-shadow:5px 5px #990000;">
        ...
        <table style="border-collapse: collapse;margin:5px 0 0 0;padding:0;">
            <tbody>
            <tr>
                <td style="font-weight: bold;color:red;width:100px;vertical-align:top;margin:0;padding:3px;">Severity:
                </td>
                <td style="vertical-align:top;margin:0;padding:3px;"><?php echo $severity; ?></td>
            </tr>
            <tr>
                <td style="font-weight: bold;color:red;width:100px;vertical-align:top;margin:0;padding:3px;">Message:
                </td>
                <td style="vertical-align:top;margin:0;padding:3px;"><?php echo $message; ?></td>
            </tr>
            <tr>
                <td style="font-weight: bold;color:red;width:100px;vertical-align:top;margin:0;padding:3px;">Filename:
                </td>
                <td style="vertical-align:top;margin:0;padding:3px;"><?php echo $filepath; ?></td>
            </tr>
            <tr>
                <td style="font-weight: bold;color:red;width:100px;vertical-align:top;margin:0;padding:3px;">Line
                    Number:
                </td>
