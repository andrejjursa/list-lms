...
class DMZ_CSV
{
     ...
     * @param mixed      $filename       The filename to export to, or a file pointer. If this is a file pointer, it
     *                                   will not be closed.
     * @param array      $fields         Array of fields to include.  If empty, includes all database columns.
     * @param bool       $include_header If FALSE the header is not exported with the CSV. Not recommended if planning
     *                                   to import this data.
     *
     ...
     * @param array      $fields     If empty, the database fields are used.  Otherwise used to limit what fields are
     *                               saved.
     * @param boolean    $header_row If true, the first line is assumed to be a header row.  Defaults to true.
     * @param mixed      $callback   A callback method for each row.  Can return FALSE on failure to save, or 'stop' to
     *                               stop the import.
     *
