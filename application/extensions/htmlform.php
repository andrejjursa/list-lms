...
class DMZ_HTMLForm
{
    ...
    function render_field($object, $field, $type = null, $options = null)
    {
        ...
        if (method_exists($this, '_input_' . $type)) {
            ...
            return '<span style="color: Maroon; background-color: White; font-weight: bold">'
                . 'FormMaker: UNABLE TO FIND A RENDERER FOR ' . $type . '</span>';
        }
     ...
     * @return string Rendered String.
     */
    function render_row($object, $field, $type = null, $options = [], $row_template = null)
    {
     ...
     * @return string Rendered String.
     */
    function render_form($object, $fields, $url = '', $options = [], $template = null, $row_template = null)
    {
        if (empty($url)) {
