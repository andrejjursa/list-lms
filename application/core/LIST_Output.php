 ...
 *
 * Responsible for sending debug Smarty final output to browser (Smarty_Internal_Debug::display_debug) using debug
 * console (pop-window)
...
class LIST_Output extends CI_Output
{
    ...
    public const IV_ACTION_RESULT = 'action_result';
    ...
    public function set_internal_value($name, $value): void
    {
        $CI =& get_instance();
    ...
    {
        $CI =& get_instance();
        return $CI->internal_values[$name] ?? null;
    }
}
// END MY_Output Class
