...
$lang['admin_task_sets_form_label_content_type'] = 'Content type';
$lang['admin_task_sets_form_label_content_type_task_set'] = 'Task set';
$lang['admin_task_sets_form_label_content_type_project'] = 'Project';
...
$lang['admin_task_sets_form_label_enable_tests_scoring'] = 'Enable automatic testing evaluation';
$lang['admin_task_sets_form_label_test_min_needed'] = 'Minimum tasks needed for evaluation';
$lang['admin_task_sets_form_label_test_min_needed_hint'] = 'Number of tasks that student must select tests for evaluation of task set solution. If this number is greater than number of tasks that have evaluating tests, it will be corrected in evaluation process.';
$lang['admin_task_sets_form_label_test_max_allowed'] = 'Maximum tasks allowed for evaluation';
$lang['admin_task_sets_form_label_test_max_allowed_hint'] = 'Maximum number of tasks that will be considered for evaluation. This number is the number of best results from tests which will be summed into points. If one task have more evaluating tests, result will be summed for that task.';
$lang['admin_task_sets_form_label_deadline_notification_emails'] = 'E-mails for deadline notification';
$lang['admin_task_sets_form_label_deadline_notification_emails_handler'] = 'Handle deadline notification e-mails as';
$lang['admin_task_sets_form_label_deadline_notification_emails_handler_0'] = 'Do not send notification e-mails.';
$lang['admin_task_sets_form_label_deadline_notification_emails_handler_1'] = 'Use these e-mails as additional to the e-mails of teachers associated to course / groups.';
$lang['admin_task_sets_form_label_deadline_notification_emails_handler_2'] = 'Send e-mail notifications only to these e-mail addresses.';
$lang['admin_task_sets_form_label_project_selection_deadline'] = 'Project selection deadline';
$lang['admin_task_sets_form_label_task_max_projects_selections'] = 'Maximum allowed selections of this task in project';
$lang['admin_task_sets_form_label_test_priority'] = 'Priority of test';
$lang['admin_task_sets_test_priority_level_1'] = 'High';
$lang['admin_task_sets_test_priority_level_2'] = 'Normal';
$lang['admin_task_sets_test_priority_level_3'] = 'Low';
$lang['admin_task_sets_form_button_submit'] = 'Save';
$lang['admin_task_sets_form_button_submit_and_open'] = 'Save and open task set';
$lang['admin_task_sets_form_field_content_type'] = 'content type';
...
$lang['admin_task_sets_form_field_test_min_needed'] = 'minimum tests needed for evaluation';
$lang['admin_task_sets_form_field_test_max_allowed'] = 'maximum tests allowed for evaluation';
$lang['admin_task_sets_form_field_deadline_notification_emails_handler'] = 'handle deadline notification e-mails as';
$lang['admin_task_sets_form_field_deadline_notification_emails'] = 'e-mails for deadline notification';
$lang['admin_task_sets_form_field_upload_end_time'] = 'solution upload end time';
$lang['admin_task_sets_form_field_project_selection_deadline'] = 'project selection deadline';
$lang['admin_task_sets_form_field_task_max_projects_selections'] = 'maximum allowed selections of this task in project';
$lang['admin_task_sets_form_field_publish_start_time'] = 'publish start time';
...
$lang['admin_task_sets_table_header_content_type'] = 'Content type';
...
$lang['admin_task_sets_table_header_project_selection_deadline'] = 'Project selection deadline';
...
$lang['admin_task_sets_tabs_label_project_selections'] = 'Project selections';
$lang['admin_task_sets_form_label_task_points_total'] = 'Points for this task';
$lang['admin_task_sets_form_label_task_test_min_points'] = 'Minimum points for test';
$lang['admin_task_sets_form_label_task_test_max_points'] = 'Maximum points for test';
$lang['admin_task_sets_form_field_task_test_max_points'] = 'maximum points for test';
$lang['admin_task_sets_form_field_task_test_min_points'] = 'minimum points for test';
...
$lang['admin_task_sets_preview_title'] = 'Task set preview';
$lang['admin_task_sets_preview_instructions_header'] = 'Instructions';
$lang['admin_task_sets_preview_task_files_title'] = 'Files';
$lang['admin_task_sets_preview_points_for_task'] = 'Points: %s';
$lang['admin_task_sets_preview_task_author'] = 'Author: %s';
$lang['admin_task_sets_preview_author_unknown'] = 'unknown';
$lang['admin_task_sets_project_selection_success'] = 'Project task successfully selected.';
$lang['admin_task_sets_project_selection_no_room'] = 'Can\'t select project task, all slots are taken.';
$lang['admin_task_sets_project_selection_already_selected'] = 'Can\'t select project task, it is already selected.';
$lang['admin_task_sets_project_selection_cant_find_data'] = 'Can\'t select project task, either task set, task, student, course or participation record not found, or given task does not belong to given task set.';
...
$lang['admin_task_sets_project_selection_fieldset_legend_not_selected'] = 'Students, which have no project task selected yet';
...
$lang['admin_task_sets_switch_to_sorting'] = 'To sorting';
$lang['admin_task_sets_switch_to_listing'] = 'To listing';
