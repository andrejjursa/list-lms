<?php if (!defined('BASEPATH')) {
	...
	class Courses extends LIST_Controller {
		...
		public function get_table_content() {
			...
			$this->parser->parse('backend/courses/table_content.tpl', array(
				'courses'       => $courses,
		...
		public function update() {
			...
			if ($this->form_validation->run()) {
				...
				if ($course->exists()) {
					$course_data = $this->input->post('course');
					$course->from_array($course_data, array(
						'name',
						'period_id',
						'capacity',
		...
		public function get_task_set_types() {
			...
			$this->parser->parse('backend/courses/task_set_types_content.tpl', array(
