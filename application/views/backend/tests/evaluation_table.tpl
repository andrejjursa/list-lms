    ...
    <tbody>
        {foreach $tasks as $task}
            <tr>
                ...
                <td class="percentage">{if array_key_exists($task->id, $real_percentage)}{$real_percentage[$task->id]}%{elseif array_key_exists($task->id, $bonus_percentage)}{$bonus_percentage[$task->id]}%{else}-{/if}</td>
