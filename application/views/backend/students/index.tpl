...
{block custom_head}<script type="text/javascript">
    var messages = {
        delete_question: '{translate|addslashes line="admin_students_message_delete_question"}',
        after_delete: '{translate|addslashes line="admin_students_message_after_delete"}'
    };
</script>{/block}