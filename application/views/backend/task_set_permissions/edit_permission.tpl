...
{block title}{translate line='admin_task_set_permisions_page_title_edit_permission'}{/block}
{block main_content}
    <h3>{translate line='admin_task_set_permisions_page_title_edit_permission'}</h3>
    {if $task_set->exists()}
    ...
    {if $task_set->exists() && !is_null($task_set->course_id)}
        <fieldset>
            <form action="{internal_url url="admin_task_set_permissions/update_permission/{$task_set->id|intval}/{$task_set_permission->id|intval}"}" method="post">
                <div class="field task_set_group_field">
                    ...
                    <p class="input"><select name="task_set_permission[group_id]" size="1" id="taks_set_permission_group_id_id">
                        {list_html_options options=$groups selected=$smarty.post.task_set_permission.group_id|default:$task_set_permission->group_id}
                    </select></p>
                ...
                <div class="field">
                    ...
                    <p class="input"><input type="text" name="task_set_permission[publish_start_time]" value="{$smarty.post.task_set_permission.publish_start_time|default:$task_set_permission->publish_start_time|escape:'html'}" id="task_permission_set_publish_start_time_id" /></p>
                ...
                <div class="field">
                    ...
                    <p class="input"><input type="text" name="task_set_permission[upload_end_time]" value="{$smarty.post.task_set_permission.upload_end_time|default:$task_set_permission->upload_end_time|escape:'html'}" id="task_set_permission_upload_end_time_id" /></p>
                ...
                <div class="field">
                    ...
                    <p class="input"><input type="text" name="task_set_permission[deadline_notification_emails]" id="task_set_permission_deadline_notification_emails_id" value="{$smarty.post.task_set_permission.deadline_notification_emails|default:$task_set_permission->deadline_notification_emails|escape:'html'}" /></p>
                ...
                <div class="field">
                    ...
                    <div class="input">{$deadline_notification_emails_handler_selected = $task_set_permission->deadline_notification_emails_handler}{if isset($smarty.post.task_set_permission.deadline_notification_emails_handler)}{$deadline_notification_emails_handler_selected = $smarty.post.task_set_permission.deadline_notification_emails_handler}{/if}
                        <label><input type="radio" name="task_set_permission[deadline_notification_emails_handler]" value="0"{if $deadline_notification_emails_handler_selected eq 0} checked="checked"{/if} /> {translate line='admin_task_sets_form_label_deadline_notification_emails_handler_0'}</label><br />
                        <label><input type="radio" name="task_set_permission[deadline_notification_emails_handler]" value="1"{if $deadline_notification_emails_handler_selected eq 1} checked="checked"{/if} /> {translate line='admin_task_sets_form_label_deadline_notification_emails_handler_1'}</label><br />
                        <label><input type="radio" name="task_set_permission[deadline_notification_emails_handler]" value="2"{if $deadline_notification_emails_handler_selected eq 2} checked="checked"{/if} /> {translate line='admin_task_sets_form_label_deadline_notification_emails_handler_2'}</label>
                    </div>
                ...
                <div class="field">
                    ...
                    <p class="input"><input type="checkbox" name="task_set_permission[enabled]" value="1" id="task_set_permission_enabled_id"{if $smarty.post.task_set_permission.enabled|default:$task_set_permission->enabled eq 1} checked="checked"{/if} /></p>
                ...
                <div class="buttons">
                    ...
                    <input type="hidden" name="taks_set_permission_room_id" value="{$smarty.post.task_set_permission.room_id|default:$task_set_permission->room_id}" />
                </div>
            </form>
        </fieldset>
    {else}
