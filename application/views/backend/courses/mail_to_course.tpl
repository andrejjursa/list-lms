            ...
            <fieldset class="basefieldset">
                ...
                <div class="field">
                    ...
                    <div class="input">
                        ...
                        </select> <br><br><label><input type="checkbox" name="course_mail[sender_copy]" value="1" {if !$smarty.post or $smarty.post.course_mail.sender_copy eq 1}checked="checked"{/if} /> {translate line="admin_courses_mail_to_course_form_label_sender_copy"}</label>
                    </div>
