...
{block main_content}
    ...
    <span class="switches"><a href="{internal_url url='admin_task_sets'}" class="switch"><i class="fa fa-arrow-right" aria-hidden="true"></i> {translate line='admin_task_sets_switch_to_listing'}</a></span>
