...
{block main_content}
    ...
    <span class="switches">
        <a href="{internal_url url='admin_course_content'}" class="switch"><i class="fa fa-arrow-right" aria-hidden="true"></i> {translate line='admin_course_content_switch_to_listing'}</a>
