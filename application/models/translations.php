...
class Translations extends CI_Model
{
    ...
    public const CONSTANT_VALIDATION_REGEXP = '/^[a-z]+[a-z0-9]*(\_[a-z0-9]+)*$/i';
     ...
     */
    public function get_translations_for_idiom($idiom, $prefix = 'user_custom_'): array
    {
        if (is_string($idiom)) {
     ...
     */
    public function get_all_for_editing(): array
    {
     ...
     */
    public function get_all_for_idiom($idiom): array
    {
